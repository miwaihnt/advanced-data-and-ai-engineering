...
【対象企業】OpenAI (Solutions Architect), Palantir (Forward Deployed Engineer), Anthropic (Applied AI)
...
実務や外資テックの面接では、本課題で実装した「プロンプトにツール仕様を書いて正規表現でパースするアプローチ（ReActの基本形）」と、OpenAIなどのAPIが提供する「ネイティブなTool Calling機能」の設計的な違いについて高い頻度で突っ込まれます。
